...
export default defineSurface({
	...
	/**
	 * THE PATTERN - ONE slot, edited by both views.
	 *
	 * The device view used to carry a `miniCode` scratchpad on an engine of its own.
	 * Two engines summing into one track is what made "who is playing" a question at
	 * all, and no answer to it was better than deleting the second engine. Both views
	 * now edit this slot; anything left in the old one is not read.
	 */
	state: {
